...
import jonathanlocke.katalyst.nucleus.data.values.bytes.Bytes.Companion.MetricFormatter
...
import jonathanlocke.katalyst.nucleus.data.values.bytes.Bytes.Companion.toBytes
...
class BytesTest {
    ...
    @Test
    fun testFormatting() {
        assertEquals(5000.toBytes().format(MetricFormatter), "5Kb")
        assertEquals(5000.toBytes().format(MetricFormatter), "5Kb")
        assertEquals(100.toBytes().toString(), "100")
    }

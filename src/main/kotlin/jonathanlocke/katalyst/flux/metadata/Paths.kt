...
class Paths {
    ...
    companion object {
        ...
        fun Path.withoutFirst() = subpath(1, nameCount) ?: throw IllegalArgumentException("Path '$this' must have a first")
        fun Path.withoutLast() = subpath(0, nameCount - 1) ?: throw IllegalArgumentException("Path '$this' must have a last")
        ...
        fun Path.extension(): Extension? {
            ...
            return if (extension.isEmpty()) null else Extension(extension)
        }

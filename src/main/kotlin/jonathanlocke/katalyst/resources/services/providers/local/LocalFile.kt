...
import jonathanlocke.katalyst.resources.streaming.ResourceInputStream
import jonathanlocke.katalyst.resources.streaming.ResourceOutputStream
...
class LocalFile(
    ...
    override fun openForWriting(progressReporter: ProgressReporter): ResourceOutputStream {
